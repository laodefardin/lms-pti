...
<div class="lms-layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @php
            $nav = [
                ['route'=>'dosen.dashboard',       'label'=>'Dashboard',    'icon'=>'fas fa-home'],
                ['route'=>'dosen.matakuliah.index','label'=>'Matakuliah',   'icon'=>'fas fa-book'],
                ['route'=>'dosen.pengumuman.index','label'=>'Pengumuman',   'icon'=>'fas fa-bullhorn'],
            ];
            $nav2 = [
                ['route'=>'dosen.profil',          'label'=>'Profil',       'icon'=>'fas fa-user'],
            ];
            @endphp
        ...
        <div class="sidebar-user" x-data="{open:false}" @click="open=!open" style="position:relative;">
            ...
            <div x-show="open" x-transition @click.outside="open=false"
                ...
                <div style="padding: 0.5rem 0; border-bottom: 1px solid var(--border);">
                    <a href="{{ route('dosen.profil') }}" style="display: flex; align-items: center; gap: 0.75rem; padding: 0.6rem 1.25rem; font-size: 0.85rem; color: var(--text-primary); text-decoration: none; transition: background 0.2s;" onmouseover="this.style.background='var(--input-bg)'" onmouseout="this.style.background='transparent'">
            ...
            <div class="topbar-actions">
                ...
                <div style="display:flex; align-items:center; gap:0.5rem; background:var(--bg-card); padding:0.25rem; border-radius:99px; border:1px solid var(--border); cursor:pointer;">
                    ...
                    <div style="padding-right:0.5rem; display:flex; flex-direction:column; justify-content:center;">
                        ...
                        <span style="font-size:0.65rem; color:var(--text-secondary); line-height:1.2;">Dosen</span>
                    </div>
                </div>
